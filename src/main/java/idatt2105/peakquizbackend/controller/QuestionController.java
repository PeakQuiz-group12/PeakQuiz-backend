...
public class QuestionController {
    ...
    @PostMapping
    public ResponseEntity<QuestionDTO> createQuestion(@RequestBody @NonNull QuestionDTO questionDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> editQuestion(@PathVariable Long id, @RequestBody @NonNull QuestionDTO questionDTO) {
