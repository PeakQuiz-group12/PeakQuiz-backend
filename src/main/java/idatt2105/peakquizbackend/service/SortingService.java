...
public class SortingService {
    ...
    /**
     * Converts an array of sort parameters into a list of Sort orders.
     * Each sort parameter should be in the format "field:direction", e.g., "createdAt:desc".
     * @param sort The array of sort parameters
